...
<style>
    /* body styles handled by global theme */
    ...
    .info-item {
        ...
        padding: 0.75rem;
        border-radius: 8px;
        border-left: 3px solid var(--ehr-primary);
    }
    ...
    .record-card {
        ...
        /* Keep record cards from becoming too tall; scroll if needed */
        max-height: 18rem;
        overflow-y: auto;
    }
    ...
    .record-card::-webkit-scrollbar {
        width: 8px;
    }

    .record-card::-webkit-scrollbar-thumb {
